!(function (a, b) {
  ...
  n.extend({
    ...
    map: function (a, b, c) {
      ...
      const h = []
      if (s(a)) {
        for (d = a.length; d > g; g++) { (e = b(a[g], g, c)), e != null && h.push(e) }
  ...
  const aa = /^\s+/
  const ba =
      'abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|fi' +
    ...
    let f =
        typeof a.getElementsByTagName !== 'undefined'
          ...
          : typeof a.querySelectorAll !== 'undefined'
            ...
            : void 0
    if (!f) {
      for (f = [], c = a.childNodes || a; (d = c[e]) != null; e++) { !b || n.nodeName(d, b) ? f.push(d) : n.merge(f, ea(d, b)) }
    }
    return void 0 === b || (b && n.nodeName(a, b)) ? n.merge([a], f) : f
  }
  function fa (a, b) {
    for (var c, d = 0; (c = a[d]) != null; d++) { n._data(c, 'globalEval', !b || n._data(b[d], 'globalEval')) }
  }
  const ga = /<|&#?\w+;/
  const ha = /<tbody/i
  function ia (a) {
  ...
  n.extend({
    ...
    clone: function (a, b, c) {
      ...
      if (
        ...
        for (d = ea(f), h = ea(a), g = 0; (e = h[g]) != null; ++g) { d[g] && Ga(e, d[g]) }
      }
      if (b) {
        if (c) {
          for (h = h || ea(a), d = d || ea(f), g = 0; (e = h[g]) != null; g++) { Fa(e, d[g]) }
        } else Fa(a, f)
      }
      return (
        (d = ea(f, 'script')),
  ...
  !(function () {
    ...
    if (j.style) {
      ...
      (i.style.cssText =
          'border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;positi' +
          'on:absolute'),
      (j.innerHTML = ''),
      i.appendChild(j),
      (l.boxSizing =
      ...
      function k () {
        ...
        m.appendChild(i),
        (j.style.cssText =
            '-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:' +
